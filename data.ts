...
export const experiences: Array<experienceTypes> = [
  {
      ...
      points: [
        ...
        "Cypress was used as an automation testing tool to test the applications that were in testing environment",
        "Validated test cases both automatically and manually in Cypress and Postman"
      ],
  },
  {
